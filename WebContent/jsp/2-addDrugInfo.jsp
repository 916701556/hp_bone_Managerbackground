                                ...
                                <div id="tab-1" class="tab-pane active">
                                    <div class="panel-body">
                                        ...
                                        <fieldset class="form-horizontal">
                                            ...
                                            <div align="right">
					                        	<button type="button" class="btn btn-w-m btn-primary" onclick="window.location.href='<%=path%>/jsp/2-1.jsp'">确认添加</button>
					                        	<button type="button" class="btn btn-w-m btn-danger" onclick="window.location.href='<%=path%>/jsp/2-1.jsp'">取消添加</button>
					                        </div> 
