    ...
    <div id="wrapper">
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="index.jsp"><i class="fa fa-th-large"></i> <span class="nav-label">系统设置</span> <span class="fa arrow"></span></a>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                  	<span class="text-muted text-xs block">欢迎来到惠普骨科,管理员 </span>
             	</li>
                <li>
		            ...
		            <div class="col-lg-12">
		                <div class="ibox float-e-margins">
		                    <div class="ibox-title">
		                        <h5>惠普骨科 <small class="m-l-sm">系统介绍</small></h5>
		        ...
		        <div class="row">
		            <div class="col-lg-12">
		                <div class="ibox float-e-margins">
		                    ...
		                    <div class="ibox-content">
		                        <p>
		                            登录日志：显示近期内系统的登录情况<br/>              
		                            操作日志：显示用户的操作记录            <br/>    
		                            基础信息管理：对各个城市，区县以及医药公司等信息的维护 <br/> 
		                            留言管理：针对患者和医生留言的管理 <br/> 
		                        </p>
		                    </div>
		                </div>
		            </div>
            ...
            <div class="wrapper wrapper-content animated fadeIn">
		        <div class="row">
		            <div class="col-lg-12">
		                <div class="ibox float-e-margins">
		                    <div class="ibox-title">
		                        <h5>药品信息管理 <small class="m-l-sm"></small></h5>
		                        <div class="ibox-tools">
		                            <a class="collapse-link">
		                                <i class="fa fa-chevron-up"></i>
		                            </a>               
