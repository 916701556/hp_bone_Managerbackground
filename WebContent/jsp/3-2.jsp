                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li class="active"><a href="<%=path%>/jsp/1-1.jsp">登陆日志</a></li>
                            <li><a href="<%=path%>/jsp/1-2.jsp">操作日志</a></li>
                            <li><a href="<%=path%>/jsp/1-3.jps">基础信息管理</a></li>
                                ...
                                <div id="tab-1" class="tab-pane active">
                                    <div class="panel-body">
                                       ...
                                       <div class="col-xs-4">
                                        ...
                                        <div class="col-xs-4" >
                                           <button type="button" class="btn btn-w-m btn-primary" onclick="window.location.href='3-1.html'">提交</button>
